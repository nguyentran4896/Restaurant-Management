...
class Slider extends Component {
	render() {
		return (
            ...
            <ul>
							<li className='dark' data-transition='fade' data-slotamount='1' data-masterspeed='1500' data-thumb='images/restaurant/slider/thumb/2.jpg' data-delay='12000'  data-saveperformance='off' data-title='Delicious Recipes'>
								...
								data-endelementdelay='0.1'
								data-endspeed='1000'
								data-endeasing='Power4.easeIn' ><a href='#' className='button button-white button-light button-border button-large button-rounded tright nomargin'><span>Browse Menu</span> <i className='icon-angle-right'></i></a></div>
							...
							<li data-transition='slidedown' data-slotamount='1' data-masterspeed='1500' data-thumb='images/restaurant/slider/thumb/1.jpg' data-delay='10000'  data-saveperformance='off'  data-title='Book your Tables'>
								...
								data-endelementdelay='0.1'
								data-endspeed='1000'
								data-endeasing='Power4.easeIn' ><a href='#' className='button button-3d button-black button-large button-rounded tright nomargin'><span>Reserve Now</span> <i className='icon-angle-right'></i></a></div>

							</li>

							<li className='dark' data-transition='slideleft' data-slotamount='1' data-masterspeed='1500' data-thumb='images/restaurant/slider/thumb/3.jpg' data-delay='12000'  data-saveperformance='off'  data-title='Full Featured Menu'>
								...
								data-endelementdelay='0.1'
								data-endspeed='1000'
								data-endeasing='Power4.easeIn' ><a href='#' className='button button-border button-white button-light button-large button-rounded tright nomargin'><span>Start Now</span> <i className='icon-angle-right'></i></a></div>
							</li>
						</ul>
					</div>
				</div>
