        ...
        <div className='content-wrap'>
          ...
          <div className='section dark bottommargin-lg' style={{'height': '500px'}}>
            <div className='container center clearfix vertical-middle'>
              ...
              <i className='i-plain i-xlarge icon-food2 divcenter bottommargin'></i>
          ...
          <div className='container clearfix'>
            ...
            <div className='col_one_fourth nobottommargin'>
              ...
              <ul className='iconlist nobottommargin'>
                <li><i className='icon-time color'></i> <strong>Mondays-Fridays:</strong> 10AM to 7PM</li>
                <li><i className='icon-time color'></i> <strong>Saturdays:</strong> 11AM to 3PM</li>
                <li><i className='icon-time text-danger'></i> <strong>Sundays:</strong> Closed</li>
              </ul>
            ...
            <div className='col_one_fourth nobottommargin'>
              ...
              <a href='#' className='button button-rounded button-dark noleftmargin'><i className='icon-file-alt'></i> Browse Menu</a>
                  ...
                  <div className='flexslider'>
                    <div className='slider-wrap'>
                      <div className='slide'>
                        ...
                        <i className='icon-star3'></i> <i className='icon-star3'></i> <i className='icon-star3'></i> <i className='icon-star3'></i> <i className='icon-star-half-full'></i>
                      </div>
                      <div className='slide'>
                        ...
                        <i className='icon-star3'></i> <i className='icon-star3'></i> <i className='icon-star3'></i> <i className='icon-star-half-full'></i> <i className='icon-star-empty'></i>
                      </div>
                      <div className='slide'>
                        ...
                        <br/>
                        <i className='icon-star3'></i> <i className='icon-star3'></i> <i className='icon-star3'></i> <i className='icon-star3'></i> <i className='icon-star-empty'></i>
                        <br/>
                      </div>
                    </div>
                  </div>
